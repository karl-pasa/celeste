<div class="row g-3">
    ...
    <style>
        ...
        .doc-choice:hover { border-color: var(--psu-navy-500); background: var(--psu-navy-050); }
        .doc-choice:focus,
        ...
        .preview-modal-body { height: 78vh; background: #eef1f6; }
        .preview-modal-body iframe { width: 100%; height: 100%; border: 0; }
    </style>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->issued): ?>
            <div class="card-celeste" wire:key="issued-<?php echo e($this->issued->id); ?>">
                ...
                <div class="p-3 p-md-4">
                    ...
                    <p class="text-muted-celeste mb-3" style="font-size:.75rem">
                        Check the printed values before handing this over. Correcting a record
                        afterwards requires a reissue, not an edit.
                    </p>
            ...
            <div class="card-celeste">
                ...
                <div class="p-3 p-md-4">
                    <ol class="ps-3 mb-0" style="font-size:.875rem;line-height:1.9;color:var(--ink-muted)">
                        ...
                        <li>The PDF is rendered with the QR already embedded, then fingerprinted.</li>
                        <li>The finished document appears here for you to check before issuing it.</li>
                    </ol>
                    <p class="text-muted-celeste mt-3 mb-0" style="font-size:.8125rem">
                        Editing a record afterwards breaks its fingerprint, and verification will report
                        the document as altered. Use reissue instead — it supersedes the old copy and
                        keeps the trail.
                    </p>
                </div>
            </div>
