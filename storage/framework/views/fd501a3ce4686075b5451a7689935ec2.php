...
<table class="security" cellpadding="0" cellspacing="0">
    <tr>
        <td width="82"><img src="<?php echo e($qr); ?>" alt="Verification QR code"></td>
        <td style="padding-left:8px">
            <span class="serial"><?php echo e($certificate->serial_number); ?></span><br>
            Scan the code or enter this serial at <?php echo e(config('app.url')); ?>/verify to confirm this document
            was issued by <?php echo e($payload['institution']); ?> and has not been altered.<br>
            <span class="hash">SHA-256 <?php echo e($certificate->content_hash); ?></span><br>
            <span class="notice">
...
<?php /**PATH C:\laragon\www\celeste\resources\views/pdf/_shell.blade.php ENDPATH**/ ?>